...
const dataDir = process.env.DATA_DIR || path.join(os.homedir(), ".dikaroute");
...
if (uninstallAlreadyInProgress) {
  ...
  try {
    execSync("npm uninstall -g dikaroute", {
      stdio: "inherit",
      env: {
        ...process.env,
        DIKAROUTE_SKIP_UNINSTALL_HOOK: "1",
      },
    });
    console.log("\n✅ DikaRoute has been successfully uninstalled from your system.");
    if (!fullUninstall) {
