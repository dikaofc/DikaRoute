...
/**
 * Writes BUILD_DIKAROUTE_BASE_PATH into the standalone bundle so container start
 * can compare the baked Next.js basePath against DIKAROUTE_BASE_PATH.
 */
...
function writeSentinel(targetDir) {
  const basePath = normalizeBasePath(process.env.DIKAROUTE_BASE_PATH);
  const sentinel = path.join(targetDir, "BUILD_DIKAROUTE_BASE_PATH");
