...
/**
 * write-build-sha.mjs — HEAD sentinel guard for DikaRoute release builds.
 *
 * Writes DIKAROUTE_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.DIKAROUTE_BUILD_SHA) {
    return process.env.DIKAROUTE_BUILD_SHA.trim();
  }
  try {
