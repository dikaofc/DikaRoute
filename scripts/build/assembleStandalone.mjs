...
/**
 * assembleStandalone.mjs - Shared standalone bundle assembler for DikaRoute.
 *
 ...
 * CLI esbuild -> bin/dikaroute.mjs                            -               Y           -    UNIQUE (prepublish)
...
const EXTRA_MODULE_ENTRIES = [
  ...
  },
  {
    ...
    // `dikaroute --mcp` at startup. See #7701.
