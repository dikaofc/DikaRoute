...
// #2939: honor DIKAROUTE_MEMORY_MB (default 512), the same knob
// `dikaroute serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.DIKAROUTE_MEMORY_MB);
