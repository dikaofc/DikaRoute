#!/usr/bin/env node
/**
 * system-info.mjs — DikaRoute System Information Reporter (#280)
 *
...
lines.push("DikaRoute System Information Report");
...
const installedGlobal = run("npm list -g dikaroute --depth=0 2>/dev/null | grep dikaroute");
lines.push(`Global npm: ${installedGlobal || "not installed globally"}`);

const pm2Status = run("pm2 list 2>/dev/null | grep dikaroute | awk '{print $4, $10, $12}'");
