...
const explicitBaseUrl = process.env.DIKAROUTE_BASE_URL || "";
  ...
  const testEnv = {
    ...
    ...(explicitBaseUrl
      ...
      : {
          ...
          DIKAROUTE_BASE_URL: baseUrl,
        }),
    DIKAROUTE_E2E_BOOTSTRAP_MODE: process.env.DIKAROUTE_E2E_BOOTSTRAP_MODE || "open",
