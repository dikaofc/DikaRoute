...
export const githubSkillTools = {
  dikaroute_github_skills_search: {
    name: "dikaroute_github_skills_search",
    description:
  ...
  dikaroute_github_skills_scan: {
    name: "dikaroute_github_skills_scan",
    description:
  ...
  dikaroute_github_skills_install: {
    name: "dikaroute_github_skills_install",
    description:
