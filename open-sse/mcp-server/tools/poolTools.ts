/**
 * DikaRoute MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. dikaroute_pool_status   — Get pool stats for one or all providers
 *   2. dikaroute_pool_sessions — List per-session details for a provider's pool
 *   3. dikaroute_pool_reset    — Shut down and recreate a pool
 *   4. dikaroute_pool_warm     — Warm up a pool to a target session count
 *   5. dikaroute_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  dikaroute_pool_status: {
    name: "dikaroute_pool_status",
    description:
  ...
  dikaroute_pool_sessions: {
    name: "dikaroute_pool_sessions",
    description:
  ...
  dikaroute_pool_reset: {
    name: "dikaroute_pool_reset",
    description:
  ...
  dikaroute_pool_health: {
    name: "dikaroute_pool_health",
    description:
  ...
  dikaroute_browser_pool_status: {
    name: "dikaroute_browser_pool_status",
    description:
