/**
 * MCP Tool Schemas — Contracts for all 23 core and advanced DikaRoute MCP tools.
 *
 ...
 *
 * Each tool wraps existing DikaRoute API endpoints and exposes them through
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "dikaroute_get_health",
  description:
    "Returns the current health status of DikaRoute including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: dikaroute_get_combo_metrics ---
...
> = {
  name: "dikaroute_get_combo_metrics",
  description:
...
// --- Tool 4b: dikaroute_create_combo ---
...
// --- Tool 6: dikaroute_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through DikaRoute's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: dikaroute_list_models_catalog ---
...
> = {
  name: "dikaroute_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "dikaroute_web_search",
  description:
    "Performs a web search using DikaRoute's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "dikaroute_web_fetch",
  description:
    "Fetches and extracts content from a URL using DikaRoute's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 9: dikaroute_simulate_route ---
...
// --- Tool 10: dikaroute_set_budget_guard ---
...
> = {
  name: "dikaroute_set_budget_guard",
  description:
...
// --- Tool 11: dikaroute_set_routing_strategy ---
...
> = {
  name: "dikaroute_set_routing_strategy",
  description:
...
// --- Tool 12: dikaroute_set_resilience_profile ---
...
> = {
  name: "dikaroute_set_resilience_profile",
  description:
...
// --- Tool 14: dikaroute_get_provider_metrics ---
...
> = {
  name: "dikaroute_get_provider_metrics",
  description:
...
// --- Tool 15: dikaroute_best_combo_for_task ---
...
> = {
  name: "dikaroute_best_combo_for_task",
  description:
...
// --- Tool 16: dikaroute_explain_route ---
...
// --- Tool 17: dikaroute_get_session_snapshot ---
...
> = {
  name: "dikaroute_get_session_snapshot",
  description:
...
// --- Tool 18: dikaroute_db_health_check ---
...
> = {
  name: "dikaroute_db_health_check",
  description:
    "Diagnoses DikaRoute database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: dikaroute_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "dikaroute_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into DikaRoute. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "dikaroute_compression_status",
  description:
...
> = {
  name: "dikaroute_compression_configure",
  description:
...
> = {
  name: "dikaroute_set_compression_engine",
...
> = {
  name: "dikaroute_list_compression_combos",
...
> = {
  name: "dikaroute_compression_combo_stats",
...
> = {
  name: "dikaroute_oneproxy_rotate",
  description:
...
> = {
  name: "dikaroute_agent_skills_list",
  description:
    "List DikaRoute agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "dikaroute_agent_skills_get",
  description:
...
// --- dikaroute_agent_skills_coverage ---
...
> = {
  name: "dikaroute_agent_skills_coverage",
  description:
