...
// local `droid` CLI. DikaRoute already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through DikaRoute.
//
...
// back to stored CLI credentials only when omitted. DikaRoute does NOT read
