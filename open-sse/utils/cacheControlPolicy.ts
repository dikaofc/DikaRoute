 ...
 * vs. applying DikaRoute's own caching strategy.
 *
 ...
 * strategies) forced DikaRoute to strip the client's markers and re-derive
 ...
 * @returns true if cache_control should be preserved, false if DikaRoute should manage it
 */
