 ...
 *
 * When DikaRoute translates a Claude-native streamed response to OpenAI Chat
 ...
 *   - Explicit opt-in: `x-dikaroute-thinking-marker: on` force-keeps it for the
 *     shrinking set of content-scanning clients (#4633).
 *   - Explicit opt-out: `x-dikaroute-thinking-marker: off` (same as default).
...
export const THINKING_MARKER_HEADER = "x-dikaroute-thinking-marker";
...
/**
 * Interpret the explicit `x-dikaroute-thinking-marker` request header.
 ...
 *   2. Explicit `x-dikaroute-thinking-marker` header → honor on/off (#5312)
