...
function applyKimiExecutionMetadata(
  ...
  providerSpecificData._dikarouteKimiTargetFormat = targetFormat;
  providerSpecificData._dikarouteKimiThinking = buildKimiThinkingMetadata(
    modelInfo,
...
export function resolveExecutionCredentials(opts: {
  ...
  if (
    ...
    providerSpecificData._dikarouteForceResponsesUpstream = true;
  }
