 ...
 */
import { buildErrorBody } from "@dikaroute/open-sse/utils/error.ts";
import { getCircuitBreaker } from "@/shared/utils/circuitBreaker";
import { isModelLocked } from "@dikaroute/open-sse/services/accountFallback.ts";
...
export async function getAutoComboCandidates(
  ...
  if (channel === "auto") {
    ...
    const { createBuiltinAutoCombo } =
      await import("@dikaroute/open-sse/services/autoCombo/builtinCatalog.ts");
