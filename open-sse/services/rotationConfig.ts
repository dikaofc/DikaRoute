 ...
 *
 * DikaRoute's account-fallback engine (accountFallback.ts) historically rotated accounts using
 ...
 *   - master enable                            DIKAROUTE_ROTATION_ENABLED               (default true)
 *   - rate-limit reset/cooldown seconds        DIKAROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS (0 => engine default)
 *   - per-status fallback enable               DIKAROUTE_ROTATE_ON_{429,500,502,400}    (429/500/502 default true, 400 default false)
 *   - per-status threshold (errors in window)  DIKAROUTE_ROTATE_{status}_THRESHOLD      (default 1 => immediate, current behavior)
 *   - per-status window seconds                DIKAROUTE_ROTATE_{status}_WINDOW_SECONDS (default 120)
 *
...
const GLOBAL_KEY = "__dikaroute_rotation_config__";
...
function buildFromEnv(): RotationConfig {
  return {
    enabled: envBool("DIKAROUTE_ROTATION_ENABLED", true),
    rateLimitResetMs: envInt("DIKAROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS", 0, 0) * 1000,
    disableTagWithoutReset: envBool("DIKAROUTE_ROTATION_DISABLE_TAG_WITHOUT_RESET", true),
    rateLimit429: buildClass(
      "DIKAROUTE_ROTATE_ON_429",
      "DIKAROUTE_ROTATE_429_THRESHOLD",
      "DIKAROUTE_ROTATE_429_WINDOW_SECONDS",
      true
    ),
    serverError500: buildClass(
      "DIKAROUTE_ROTATE_ON_500",
      "DIKAROUTE_ROTATE_500_THRESHOLD",
      "DIKAROUTE_ROTATE_500_WINDOW_SECONDS",
      true
    ),
    badGateway502: buildClass(
      "DIKAROUTE_ROTATE_ON_502",
      "DIKAROUTE_ROTATE_502_THRESHOLD",
      "DIKAROUTE_ROTATE_502_WINDOW_SECONDS",
      true
    ),
    badRequest400: buildClass(
      "DIKAROUTE_ROTATE_ON_400",
      "DIKAROUTE_ROTATE_400_THRESHOLD",
      "DIKAROUTE_ROTATE_400_WINDOW_SECONDS",
      false
    ),
  };
}
...
const COUNTER_KEY = "__dikaroute_rotation_counters__";
