...
export interface ResolveAutoStrategyDeps {
  ...
  relayOptions?: {
    ...
    sessionId?: string | null;
    /** Per-request X-DikaRoute-Mode value (#6024/#6025). */
    mode?: string | null;
    /** Per-request X-DikaRoute-Budget value in USD (#6023). */
    budgetCap?: number | null;
    /** Per-request X-DikaRoute-Budget-Fallback value ("cheapest" | "strict") — #3470. */
...
export async function resolveAutoStrategyOrder(
  ...
  // Per-request overrides (#6023 / #6024 / #6025 / #3470): X-DikaRoute-Budget,
  // X-DikaRoute-Budget-Fallback and X-DikaRoute-Mode headers (threaded via
  ...
  // per-request X-DikaRoute-Mode override — but `scoreAutoTargets()` (the fallback
