...
export const SKIP_UNIVERSAL_HANDOFF_FLAG = "_dikarouteSkipUniversalHandoff";
...
async function generateHandoffAsync(options: {
  ...
  const summaryBody = {
    ...
    temperature: 0.1,
    _dikarouteSkipContextRelay: true,
    _dikarouteInternalRequest: "context-handoff",
  };
...
async function generateUniversalHandoffAsync(options: {
  ...
  const summaryBody: Record<string, unknown> = {
    ...
    temperature: 0.1,
    _dikarouteSkipContextRelay: true,
    _dikarouteInternalRequest: "universal-handoff",
  };
