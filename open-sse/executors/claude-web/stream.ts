...
function responseHeaders(contentType: string, metadata: Record<string, string>): Headers {
  ...
  const headerNames: Record<string, string> = {
    operation: "X-DikaRoute-Claude-Web-Operation",
    conversation_id: "X-DikaRoute-Claude-Web-Conversation-Id",
    parent_message_uuid: "X-DikaRoute-Claude-Web-Parent-Message-Uuid",
    assistant_message_uuid: "X-DikaRoute-Claude-Web-Assistant-Message-Uuid",
  };
