 ...
 * DikaRoute downgrades it to `/chat/completions` — so the MCP namespaces never
...
export function shouldForceResponsesUpstream(
  ...
  if (providerSpecificData?._dikarouteForceResponsesUpstream === true) return true;
...
export function withForcedResponsesUpstream<T extends CredentialsLike>(
  ...
  return {
    ...
    providerSpecificData: {
      ...
      _dikarouteForceResponsesUpstream: true,
    },
  } as T;
}
