 ...
 * to OpenAI Chat Completions chunks by reusing DikaRoute's own translators
 ...
 * adapted to TypeScript + DikaRoute's BaseExecutor/translator conventions.
...
function resolveZedSuppressThinkClose(
  ...
  return resolveSuppressThinkClose({
    ...
    thinkingMarkerHeader:
      ...
      clientHeaders?.["x-dikaroute-thinking-marker"] ??
      null,
    ...
    const response = await zedLlmFetch(zedCredentials, "/completions", {
      ...
      fetchOptions: {
        ...
        headers: {
          ...
          "User-Agent": `DikaRoute/zed-hosted`,
