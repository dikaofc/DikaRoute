 ...
 *
 *   1. The client (DikaRoute) generates an ephemeral RSA keypair.
 ...
 *   5. DikaRoute decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + DikaRoute conventions. `fetch` is intentionally the
