...
/**
 * Shared repair action used by both `dikaroute runtime repair` and the
 * top-level `dikaroute repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `dikaroute repair` invokes the SAME action
  // as `dikaroute runtime repair` (no duplicated logic). Surfaced in the
