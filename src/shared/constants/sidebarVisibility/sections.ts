...
export const SIDEBAR_SECTIONS: readonly SidebarSectionDefinition[] = [
  ...
  },
  {
    ...
    titleFallback: "DikaRoute",
    children: [
      ...OMNI_PROXY_ITEMS.slice(0, 3), // endpoints, api-manager, providers
      ...OMNI_PROXY_ITEMS.slice(4, 7), // combos, combos-live, quota
    ],
  },
  {
    id: "analytics",
    ...
    children: ANALYTICS_ITEMS.slice(3, 4), // cache (low latency)
  },
  {
    id: "monitoring",
