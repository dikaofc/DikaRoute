...
export const OAUTH_PROVIDERS = {
  ...
  "kimi-coding": {
    ...
    riskNoticeVariant: "oauth",
    authHint:
      "Sign in with the same Kimi account used by Kimi Code CLI. DikaRoute uses the CLI OAuth flow and Kimi Coding Plan endpoints.",
  },
  kilocode: {
    id: "kilocode",
    alias: "kc",
