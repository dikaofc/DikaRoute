  ...
  const startOAuthFlow = useCallback(
    async (opts?: { grokBrowser?: boolean }) => {
      ...
      try {
        ...
        // show an auth code instead of redirecting back to DikaRoute.
        ...
        // 127.0.0.1:<port> callback that DikaRoute never listens on (the port is
        ...
        if (provider === "codex" || provider === "openai") {
          ...
          // Remote fallback: use DikaRoute's port with the /auth/callback path Windsurf expects.
          ...
          // Behind reverse proxy: use actual origin (e.g., https://dikaroute.example.com/callback)
