...
const footerLinks = {
  ...
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/dikaofc/DikaRoute/discussions",
      external: true,
    },
  
  {
    label: "Telegram",
    href: "https://t.me/execuidorbaru",
    external: true,
  },
  {
    label: "Owner",
  ...
  company: [
    { label: "About", href: "https://github.com/dikaofc/DikaRoute", external: true },
    { label: "Blog", href: "https://github.com/dikaofc/DikaRoute/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/dikaofc/DikaRoute/issues/new/choose",
      external: true,
    },
