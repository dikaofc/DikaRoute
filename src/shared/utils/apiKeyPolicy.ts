...
import { checkTokenLimits } from "@dikaroute/open-sse/services/tokenLimitCounter.ts";
import {
  errorResponse,
  buildErrorBody,
...
const PLAYGROUND_KEY_ID_HEADER = "x-dikaroute-playground-key-id";
 ...
 * `x-dikaroute-playground-key-id` and we resolve the secret server-side.
 *
