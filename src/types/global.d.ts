/**
 * Global Type Declarations for DikaRoute
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    DIKAROUTE_PUBLIC_BASE_URL?: string;
    DIKAROUTE_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    DIKAROUTE_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    DIKAROUTE_BASE_URL?: string;
    DIKAROUTE_DISABLE_BACKGROUND_SERVICES?: string;
    DIKAROUTE_PORT?: string;
