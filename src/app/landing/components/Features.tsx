...
const FEATURES = [
  ...
  },
  {
    ...
    colors: {
      border: "hover:border-[#0a84ff]/50",
      bg: "hover:bg-[#0a84ff]/5",
      iconBg: "bg-[#0a84ff]/10",
      iconText: "text-[#0a84ff]",
      titleHover: "group-hover:text-[#64d2ff]",
    },
  },
  {
    icon: "terminal",
    ...
    colors: {
      border: "hover:border-[#30d158]/50",
      bg: "hover:bg-[#30d158]/5",
      iconBg: "bg-[#30d158]/10",
      iconText: "text-[#30d158]",
      titleHover: "group-hover:text-[#32d74b]",
    },
  },
  {
    icon: "dashboard",
