...
export const metadata: Metadata = {
  title: "DikaRoute Documentation",
  description:
    "Everything you need to route, compress, and scale your AI — setup guides, API reference, compression, deployment, and more.",
  openGraph: {
    title: "DikaRoute Documentation",
    description:
      "Comprehensive docs for DikaRoute AI gateway — setup, API, compression, deployment, and more.",
    type: "website",
    url: "https://obitoglory.tech/docs",
  },
  twitter: {
    card: "summary_large_image",
    title: "DikaRoute Documentation",
    description: "Comprehensive docs for DikaRoute AI gateway",
  },
};
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">DikaRoute Documentation</h1>
