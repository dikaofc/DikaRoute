...
const LS_PURCHASE_FILTER = "dikaroute:limits:purchaseFilter";
const LS_STATUS_FILTER = "dikaroute:limits:statusFilter";
const LS_ENV_FILTER = "dikaroute:limits:envFilter";
const LS_PROVIDER_FILTER = "dikaroute:limits:providerFilter";
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: active ? "var(--color-primary, #0a84ff)" : "var(--color-text-muted)",
                  }}
                >
