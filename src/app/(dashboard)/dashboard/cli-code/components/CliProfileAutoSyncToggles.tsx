...
const CODEX_KEY = "DIKAROUTE_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "DIKAROUTE_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the DIKAROUTE_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
