...
import { getRegistryEntry } from "@dikaroute/open-sse/config/providerRegistry";
import type { AlternateFormat } from "@dikaroute/open-sse/config/providers/alternateFormats";
import {
