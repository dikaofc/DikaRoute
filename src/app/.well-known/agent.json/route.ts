 ...
 *
 * Serves the DikaRoute A2A Agent Card for discovery by other agents.
...
const BASE_URL = process.env.DIKAROUTE_BASE_URL || "http://localhost:20128";

/**
 * GET /.well-known/agent.json
 *
 * Returns the DikaRoute Agent Card that describes this gateway's
  ...
  const agentCard = {
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 DikaRoute agent skills (22 API + 20 CLI) " +
