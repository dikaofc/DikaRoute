...
import { resolveNestedComboTargets } from "@dikaroute/open-sse/services/combo.ts";
    ...
    try {
      res = await fetch(internalUrl, {
        ...
        headers: {
          ...
          // DikaRoute's semantic cache or other request reuse layers.
          "X-DikaRoute-No-Cache": "true",
          ...(target.connectionId ? { "X-DikaRoute-Connection": target.connectionId } : {}),
