...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@dikaroute/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@dikaroute/open-sse/services/sessionManager.ts");
