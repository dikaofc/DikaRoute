 ...
 * Uses DikaRoute's skill registry + CLI tool paths (no Skill Collector bridge).
 *
 * Body: {
...
import { sanitizeErrorMessage, buildErrorBody } from "@dikaroute/open-sse/utils/error";
