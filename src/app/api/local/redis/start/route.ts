...
const HOST_PORT = process.env.DIKAROUTE_REDIS_HOST_PORT || "6379";
const BIND_HOST = process.env.DIKAROUTE_REDIS_BIND_HOST || REDIS_DEFAULT_BIND_HOST;
const IMAGE = process.env.DIKAROUTE_REDIS_IMAGE || "docker.io/redis:7-alpine";
