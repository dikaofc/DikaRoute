...
export const REDIS_CONTAINER_NAME = process.env.DIKAROUTE_REDIS_CONTAINER_NAME || "dikaroute-redis";
...
// DIKAROUTE_REDIS_BIND_HOST and secure the instance themselves.
