...
import { sanitizeErrorMessage, buildErrorBody } from "@dikaroute/open-sse/utils/error.ts";
 ...
 *
 * DikaRoute Copilot chat endpoint.
 * Accepts user messages about DikaRoute configuration and returns
