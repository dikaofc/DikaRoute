import { computeFreeModelTotals } from "@dikaroute/open-sse/config/freeModelCatalog.ts";
import { FREE_CATALOG_CURATED_AT } from "@dikaroute/open-sse/config/freeModelCatalog.data.ts";
