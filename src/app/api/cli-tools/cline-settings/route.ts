...
// Check if DikaRoute is configured as OpenAI-compatible provider
const hasDikaRouteConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasDikaRoute: hasDikaRouteConfig(globalState),
...
// POST - Configure Cline to use DikaRoute as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_dikaroute";
...
// DELETE - Remove DikaRoute OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "DikaRoute settings removed from Cline",
    });
  } catch (error) {
