...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@dikaroute/open-sse/services/rateLimitManager"),
      import("@dikaroute/open-sse/services/accountFallback"),
      import("@dikaroute/open-sse/services/requestDedup.ts"),
      import("@dikaroute/open-sse/services/quotaMonitor.ts"),
      import("@dikaroute/open-sse/services/sessionManager.ts"),
      import("@/lib/credentialHealth/cache"),
      import("@/lib/localHealthCheck"),
      import("@dikaroute/open-sse/services/admission/runtime.ts"),
      getCachedSettings(),
