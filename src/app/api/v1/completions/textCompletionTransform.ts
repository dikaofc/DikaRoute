/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. DikaRoute routes
 ...
 * the model they asked for, and the `x-dikaroute-model` response header
 ...
 * requested identifier (matching the `x-dikaroute-model` response header).
 */
