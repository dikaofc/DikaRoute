...
import { generateProviderPluginManifest } from "@dikaroute/open-sse/config/providerPluginManifestRegistry.ts";
...
import type {
  ...
  ProviderPluginModel,
} from "@dikaroute/open-sse/config/providerPluginManifest.ts";
