import { handleSearch } from "@dikaroute/open-sse/handlers/search.ts";
import {
...
} from "@dikaroute/open-sse/config/searchRegistry.ts";
...
} from "@dikaroute/open-sse/services/searchCache.ts";
import {
