import { handleImageUpscale } from "@dikaroute/open-sse/handlers/imageUpscale.ts";
import {
  getUpscaleProvider,
  getAllUpscaleModels,
  parseUpscaleModel,
} from "@dikaroute/open-sse/config/upscaleRegistry.ts";
import { extractUpscaleSourceImage } from "@dikaroute/open-sse/handlers/imageUpscale/shared.ts";
...
async function postHandler(request: Request) {
  ...
  if (result.success) {
    ...
    attachDikaRouteMetaHeaders(headers, {
      provider,
