...
import { initTranslators } from "@dikaroute/open-sse/translator/index.ts";
...
} from "@dikaroute/open-sse/utils/earlyStreamKeepalive";
import { resolveKeepaliveThreshold } from "@dikaroute/open-sse/utils/keepaliveThreshold";
import {
  admitChatRequest,
  admitChatStructure,
...
export async function POST(request) {
  ...
  try {
    ...
    // typical chat payloads. Toggle off via DIKAROUTE_LOG_REQUEST_SHAPE=0.
    if (process.env.DIKAROUTE_LOG_REQUEST_SHAPE !== "0") {
