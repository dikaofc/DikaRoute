...
function getSchedulerState() {
  if (!globalThis.__dikarouteCredentialHC) {
    globalThis.__dikarouteCredentialHC = {
      initialized: false,
      sweepTimer: null,
  ...
  return globalThis.__dikarouteCredentialHC;
}
...
function isCredentialHealthCheckDisabled(): boolean {
  ...
  const val = process.env.DIKAROUTE_DISABLE_CREDENTIAL_HEALTH_CHECK;
