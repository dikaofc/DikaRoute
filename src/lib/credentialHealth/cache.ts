...
declare global {
  var __dikarouteCredentialCache:
    | {
        initialized: boolean;
...
function getCacheState() {
  if (!globalThis.__dikarouteCredentialCache) {
    globalThis.__dikarouteCredentialCache = {
      initialized: false,
      cache: new Map(),
    };
  }
  return globalThis.__dikarouteCredentialCache;
}
