...
/**
 * Maps Arena leaderboard categories to DikaRoute task-type categories.
 *
...
/**
 * DikaRoute model aliases: canonical name → known aliases.
 * Creates additional DB entries for each alias so that models
 * are findable under any name DikaRoute uses internally.
 */
 ...
 *
 * Leaderboard categories are mapped to DikaRoute task types:
 * - "text" → default, review, documentation, debugging
 * - "code" → coding
 *
 * Known DikaRoute model aliases are also expanded into additional entries.
 *
