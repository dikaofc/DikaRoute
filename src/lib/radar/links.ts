 ...
 * supporter-plans (payment) page on the private radar.obitoglory.tech
 * server.
 *
...
const DEFAULT_CONTRIBUTOR_CLAIM_URL = "https://radar.obitoglory.tech/auth/github";

/** Default supporter plans/payment page. */
const DEFAULT_SUPPORTER_PLANS_URL = "https://radar.obitoglory.tech/planos";
