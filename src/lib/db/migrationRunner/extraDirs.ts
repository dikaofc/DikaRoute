 ...
 * space: `NNN_name.sql` is recorded in `_dikaroute_migrations` as `NNN`. That
 ...
 * namespace:
 *
 *   DIKAROUTE_EXTRA_MIGRATIONS_DIRS="ee=/opt/app/enterprise/db/migrations"
 *
...
export const EXTRA_MIGRATIONS_DIRS_ENV = "DIKAROUTE_EXTRA_MIGRATIONS_DIRS";
