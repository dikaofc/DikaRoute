...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'dikaroute'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with DikaRoute
...
-- Determines whether each provider uses DikaRoute's native executor,
