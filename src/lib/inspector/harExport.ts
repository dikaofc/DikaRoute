 ...
 * trace out of DikaRoute into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The DikaRoute capture source
...
const CREATOR_NAME = "DikaRoute Traffic Inspector";
