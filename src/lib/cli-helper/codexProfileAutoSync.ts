...
function isAutoSyncEnabled() {
  // Opt-in, default OFF. Backed by the DIKAROUTE_AUTO_SYNC_CODEX_PROFILES feature flag
  ...
  return isFeatureFlagEnabled("DIKAROUTE_AUTO_SYNC_CODEX_PROFILES");
}
...
export async function autoSyncCodexProfilesFromLiveCatalog(
  ...
  // Reuse the CLI generator so automatic sync and `dikaroute setup-codex`
