...
import { parseModel, resolveCanonicalProviderModel } from "@dikaroute/open-sse/services/model.ts";
import {
...
import { getUnsupportedParams } from "@dikaroute/open-sse/config/providerRegistry.ts";
import {
  getLearnedThinkingCap,
  GEMINI_FALLBACK_THINKING_CAP,
} from "@dikaroute/open-sse/services/learnedThinkingCaps.ts";
...
function reverseModelsDevProviders(provider: string): readonly string[] {
  // models.dev may store capabilities under a different DikaRoute provider id
