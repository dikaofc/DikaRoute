...
import { validateQoderCliPat } from "@dikaroute/open-sse/services/qoderCli.ts";
...
export async function validateAuggieProvider() {
  const { checkAuggieCliVersion } = await import("@dikaroute/open-sse/executors/auggie.ts");
