...
import {
  ...
  type ScoringWeights,
  validateWeights,
} from "@dikaroute/open-sse/services/autoCombo/scoring.ts";
import { getModePack } from "@dikaroute/open-sse/services/autoCombo/modePacks.ts";
import { getTaskFitness } from "@dikaroute/open-sse/services/autoCombo/taskFitness.ts";
import type {
  ComboAutopilotCombo,
