...
import { DIKAROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@dikaroute/open-sse/services/webSearchFallback.ts";
import { DIKAROUTE_WEB_FETCH_FALLBACK_TOOL_NAME } from "@dikaroute/open-sse/services/webFetchInterception.ts";
...
const BUILTIN_TOOL_ALIASES: Record<string, string> = {
  [DIKAROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME]: "web_search",
  [DIKAROUTE_WEB_FETCH_FALLBACK_TOOL_NAME]: "web_fetch",
};
...
export async function handleToolCallExecution(
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      // blocks untouched, remove the DikaRoute-handled tool_use blocks, and expose
