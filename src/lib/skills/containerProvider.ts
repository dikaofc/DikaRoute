/**
 * Container runtime providers for the DikaRoute skill sandbox.
 *
 * The sandbox historically hardcoded the `docker` CLI. This module abstracts
 * the container runtime so DikaRoute can pick the most performant / native
...
const SANDBOX_NAME = (sandboxId: string) => `dikaroute-${sandboxId}`;
