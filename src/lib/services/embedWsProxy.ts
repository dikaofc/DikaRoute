 ...
 *     is set explicitly. The DikaRoute LOCAL_ONLY rule is enforced at the
...
declare global {
  var __dikarouteEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__dikarouteEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__dikarouteEmbedWsStarted = true;
