...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-dikaroute-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-dikaroute-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-dikaroute-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-dikaroute-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-dikaroute-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-dikaroute-cli-token";
 ...
 * token matches this process's DIKAROUTE_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-dikaroute-peer-ip";
 ...
 * proxy hop (e.g. DikaRoute behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-dikaroute-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-dikaroute-peer-locality";
